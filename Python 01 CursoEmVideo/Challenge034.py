...
if salary > 1250:
    print('You will receive an increase of ${:.2f} and your total salary will be R${:.2f}'.format(salary*0.1, (salary*0.1)+salary))

else:
    print('You will receive an increase of ${:.2f} and your total salary will beR${:.2f}'.format(salary*0.15, (salary*0.15)+salary))